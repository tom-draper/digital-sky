...
function fillSkyDefaults() {
  ...
  document.getElementById("skyColour").value = rgbToHex(
...
function fillMoonDefault() {
  ...
  document.getElementById("moonColour").value = rgbToHex(
...
function collectSky() {
  ...
  config.sky.properties.colour = hexToRGB(
    document.getElementById("skyColour").value
  );
...
function collectMoon() {
  ...
  config.moon.properties.colour = hexToRGB(
    document.getElementById("moonColour").value
  );
