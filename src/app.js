...
function colourSky(grid, skyConfig) {
    ...
    var startColour = __spreadArray(__spreadArray([], skyConfig.properties.colour, true), [
...
function createSunsetLayer(grid, layerConfig) {
    ...
    toPaint.push([start[0], start[1], __spreadArray(__spreadArray([], layerConfig.colour, true), [1], false)]);
    seen.add(start);
    var x;
    var y;
    var colour;
